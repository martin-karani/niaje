...
CREATE TYPE "public"."document_storage_provider" AS ENUM('local', 's3', 'google_cloud_storage', 'azure_blob');--> statement-breakpoint
CREATE TYPE "public"."document_type" AS ENUM('lease_agreement', 'tenant_id', 'inspection_report', 'property_photo', 'unit_photo', 'maintenance_invoice', 'notice', 'other');--> statement-breakpoint
...
CREATE TABLE "documents" (
	...
	"mime_type" text,
	"file_size" integer,
	"storage_provider" "document_storage_provider" DEFAULT 'local' NOT NULL,
...
CREATE TABLE "utility_bills" (
	...
	"amount" numeric(10, 2) NOT NULL,
	"utility_bill_status" "utility_bill_status" DEFAULT 'due' NOT NULL,
...
ALTER TABLE "communications" ADD CONSTRAINT "communications_sender_user_id_user_id_fk" FOREIGN KEY ("sender_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "communications" ADD CONSTRAINT "communications_recipient_user_id_user_id_fk" FOREIGN KEY ("recipient_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "documents" ADD CONSTRAINT "documents_related_property_id_properties_id_fk" FOREIGN KEY ("related_property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "documents" ADD CONSTRAINT "documents_related_unit_id_units_id_fk" FOREIGN KEY ("related_unit_id") REFERENCES "public"."units"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "documents" ADD CONSTRAINT "documents_related_lease_id_leases_id_fk" FOREIGN KEY ("related_lease_id") REFERENCES "public"."leases"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "documents" ADD CONSTRAINT "documents_related_tenant_id_tenants_id_fk" FOREIGN KEY ("related_tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "documents" ADD CONSTRAINT "documents_related_inspection_id_inspections_id_fk" FOREIGN KEY ("related_inspection_id") REFERENCES "public"."inspections"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "leases" ADD CONSTRAINT "leases_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "leases" ADD CONSTRAINT "leases_property_id_units_property_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."units"("property_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "organization" ADD CONSTRAINT "organization_agent_owner_id_user_id_fk" FOREIGN KEY ("agent_owner_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team" ADD CONSTRAINT "team_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "properties" ADD CONSTRAINT "properties_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "properties" ADD CONSTRAINT "properties_owner_id_user_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."user"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "properties" ADD CONSTRAINT "properties_caretaker_id_user_id_fk" FOREIGN KEY ("caretaker_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tenants" ADD CONSTRAINT "tenants_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "units" ADD CONSTRAINT "units_organization_id_properties_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."properties"("organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "inspections" ADD CONSTRAINT "inspections_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "inspections" ADD CONSTRAINT "inspections_inspector_id_user_id_fk" FOREIGN KEY ("inspector_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "maintenance_requests" ADD CONSTRAINT "maintenance_requests_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "maintenance_requests" ADD CONSTRAINT "maintenance_requests_reported_by_user_id_fk" FOREIGN KEY ("reported_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "maintenance_requests" ADD CONSTRAINT "maintenance_requests_assigned_to_user_id_fk" FOREIGN KEY ("assigned_to") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "expenses" ADD CONSTRAINT "expenses_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payments" ADD CONSTRAINT "payments_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "utility_bills" ADD CONSTRAINT "utility_bills_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "provider_account_idx" ON "account" USING btree ("provider_id","account_id");--> statement-breakpoint
CREATE INDEX "identifier_value_idx" ON "verification" USING btree ("identifier","value");