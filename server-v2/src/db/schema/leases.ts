...
import { payments, utilityBills } from "./payments";
import { properties } from "./properties";
import { leaseTenants } from "./tenants";
...
export const leases = pgTable("leases", {
  ...
  lateFeeType: lateFeeTypeEnum("late_fee_type").default("no_fee"), // Type of late fee (fixed, percentage, none)
...
export const leasesRelations = relations(leases, ({ one, many }) => ({
  ...
  creator: one(user, {
    // User (agent staff) who created the lease
