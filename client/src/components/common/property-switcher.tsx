...
export function PropertySwitcher() {
  ...
  const LogoComponent = activeProperty.logo || Building;
        ...
        <DropdownMenu>
          ...
          >
            ...
            {properties.map((property, index) => {
              const PropertyLogo = property.logo || Building;
              return (
                <DropdownMenuItem
                  key={property.id}
                ...
                >
                  <div className="flex size-6 items-center justify-center rounded-sm border">
                    <PropertyLogo className="size-4 shrink-0" />
                  </div>
                  {property.name}
