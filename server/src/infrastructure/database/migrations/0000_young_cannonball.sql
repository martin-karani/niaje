...
ALTER TABLE "documents" ADD CONSTRAINT "documents_related_inspection_id_inspections_id_fk" FOREIGN KEY ("related_inspection_id") REFERENCES "public"."inspections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
